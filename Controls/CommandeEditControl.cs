...
{
    public partial class CommandeEditControl : UserControl
    {
        ...
        public CommandeEditControl(Commande commande)
        {
            _commande = commande;
            _details = commande.Details.ToList();
            InitializeComponent();
            CreateControls();
            LoadData();
            LoadCommandeData();
